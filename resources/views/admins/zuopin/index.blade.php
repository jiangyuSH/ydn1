                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										...
										<tr class="odd gradeX">
                                            <td>{{$user['zid']}}</td>
                                            <td>{{$user['uid']}}</td>
                                            <td><image src="{{asset($user['zimage'])}}" style="height:40px;width:40px"></td>
                                            <td>{{$user['zshow']}}</td>
                                            <td>
											    <button data-id="{{$user['zid']}}" class="update " data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-pencil"></span></button>  
												<button data-id="{{$user['zid']}}" class="delete"><span class="glyphicon glyphicon-remove"></span></button>
											</td>
