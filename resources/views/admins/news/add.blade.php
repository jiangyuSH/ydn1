                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
								<div class="col-lg-7">
									<form role="form" action="/admins/news/insert" method="post" enctype="multipart/form-data">
										{!! csrf_field() !!}
										 <div class="form-group">
                                            <label>用户名</label>
                                            <input class="form-control" name="nname">
										 ...
										 <div class="form-group">
                                            ...
                                            <p><textarea name="ncontent" cols=120 rows=5></textarea></p>
                                        </div>
